...
func userAgentProducts(uap []*httpclient.UAProduct) []*awsbase.UserAgentProduct {
...
func (c *Config) Client() (interface{}, error) {
	...
	uaProducts := userAgentProducts(httpclient.UserAgent(c.terraformVersion).Products())
